    ...
    <div class="collapse navbar-collapse yo" id="basicExampleNav">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="https://www.facebook.com/Foodogs-271463316621113/" target="_blank"><img class="imageNav" src="http://localhost/foodog/wp-content/uploads/2019/01/logo-facebook_318-10753.jpg"></a>
            </li>
            <li class="nav-item">
            ...
            <button type="button" data-toggle="modal" data-target="#infos" class="btn loupe">
                <li class="nav-item">
                    <a class="nav-link" href="#"><img class="imageNav" src="http://localhost/foodog/wp-content/uploads/2019/01/Find01-512.png"></a>
                </li>
            </button>
        ...
        <nav class="navbar navbar-expand navup2">
            ...
            <div class="collapse navbar-collapse" id="basicExampleNav">
                ...
                <ul class="navbar-nav mr-auto yo">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/foodog/category/wellness/">Welness</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/foodog/category/lifestyle/">Lifestyle</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/foodog/category/community/">Community</a>
                    </li>
                </ul>
            </div>
            <!-- Collapsible content -->
